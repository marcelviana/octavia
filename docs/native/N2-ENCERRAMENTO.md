...
| # | item |
|---|---|
| 1 | o tablet em **retrato** precisa de composição própria — os elementos se encavalam; o canvas do N1/N2 é só paisagem (N2-D25) — **N3 em curso** (decidido pelo Marcel, N3-D6): pre-check #324 ([`N3-PRECHECK.md`](N3-PRECHECK.md); "se encavalam" medido falso na forma, H-N3-7) e desenho congelado em [`DESIGN-N3/`](DESIGN-N3/) (N3-D12…D25); requisitos em [`N3-REQUISITOS.md`](N3-REQUISITOS.md) — **fechado pelo N3** (#324–#333; o tablet em pé na faixa B, a paisagem intacta): [`N3-ENCERRAMENTO.md`](N3-ENCERRAMENTO.md); o celular segue no N5 |
| 2 | app **iOS** |
