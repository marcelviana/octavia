...
| `dumps/` | **os 11 dumps do §4.1**, todos do mock, com `SHA256SUMS.txt` |
| `png/` | três recortes do mock: a linha erguida (`03`), a faixa do `N2-X-100` (`08`), a barra e o aviso da falha (`10`) |
| `device-prod.txt` | **§4.2**: as três escritas em prod, logcat verbatim, o corpo do `PUT` com ids mascarados e as ordens antes/depois |
| `aparato.md` | o §4 inteiro: G5/G6, as medidas contra o congelado, o defeito achado e consertado (div. 286), o aparato do Metro (div. 294) e as mutações locais |
