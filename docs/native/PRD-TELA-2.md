...
*Errata da N3-PR6 (2026-09-25) — o J3 em **retrato** (faixa B, `N3-PR6-anexos/j3-retrato.txt`)*: os mesmos **16 gestos** da paisagem, por troca. As cinco músicas cabem sem rolar (a paisagem rolava para a 5ª), mas o **teclado encaixado** de retrato (topo 761,3 dp) cobre o rodapé do picker, e o `Concluir` só se alcança depois de fechar o teclado — um gesto que a paisagem não tinha (div. 450, com o Marcel). Os "≤ 3 taps por música" continuam: `Adicionar música` · digitar · `Adicionar` na primeira, 1 nas seguintes.
...
*Errata da N3-PR6 (2026-09-25) — a linha do picker com falha em **B*** (N3-E18, div. 445): o aceite continua o mesmo (a frase inteira na linha, `Tentar de novo` só depois da releitura), mas a **forma** muda na faixa B: a fileira de 80 não comporta título + frase + ação em 711 dp (o título sumia e o `Tentar de novo` era cortado pela janela), e a linha que falha (500) ou bate no limite (429) empilha — título em cima, a frase e o `Tentar de novo` num 2º andar, linha de 138,7. Em C, a fileira de sempre. `N3-PR6-anexos/README.md` §2.
