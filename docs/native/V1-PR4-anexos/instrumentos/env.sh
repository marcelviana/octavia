...
export SP=<scratch>
export UID_AUDIT=Pw3bxXZw0iT3WwyL7kxGtGJIJH83
...
store() { RA "cd files/octavia-$UID_AUDIT && sha256sum content.json setlists.json files-index.json files/* 2>&1"; echo "--- files-index.json:"; RA "cat files/octavia-$UID_AUDIT/files-index.json"; echo; }
pingprova() { E shell "settings get global airplane_mode_on"; E shell "ping -c 2 -W 2 8.8.8.8" 2>&1 | tail -3; }
