...
CREATE POLICY "Allow authenticated uploads" ON "storage"."objects" FOR INSERT WITH CHECK ((("auth"."role"() = 'authenticated'::"text") AND ("bucket_id" = 'content-files'::"text")));



CREATE POLICY "Allow authenticated uploads to content-files" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK (("bucket_id" = 'content-files'::"text"));



CREATE POLICY "Allow authenticated uploads to content-files 1bf93c3_0" ON "storage"."objects" FOR SELECT TO "authenticated" USING (("bucket_id" = 'content-files'::"text"));



CREATE POLICY "Allow authenticated uploads to content-files 1bf93c3_1" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK (("bucket_id" = 'content-files'::"text"));



CREATE POLICY "Allow authenticated uploads to content-files 1bf93c3_2" ON "storage"."objects" FOR UPDATE TO "authenticated" USING (("bucket_id" = 'content-files'::"text"));



CREATE POLICY "Allow authenticated uploads to content-files 1bf93c3_3" ON "storage"."objects" FOR DELETE TO "authenticated" USING (("bucket_id" = 'content-files'::"text"));



CREATE POLICY "Allow deleting content-files" ON "storage"."objects" FOR DELETE TO "authenticated" USING (("bucket_id" = 'content-files'::"text"));



CREATE POLICY "Allow public access" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'content-files'::"text"));



CREATE POLICY "Allow public read access to content-files" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'content-files'::"text"));



CREATE POLICY "Allow service role access to content-files" ON "storage"."objects" USING ((("bucket_id" = 'content-files'::"text") AND ("auth"."role"() = 'service_role'::"text")));



CREATE POLICY "Allow updating content-files" ON "storage"."objects" FOR UPDATE TO "authenticated" USING (("bucket_id" = 'content-files'::"text"));



CREATE POLICY "Allow viewing content-files" ON "storage"."objects" FOR SELECT TO "authenticated" USING (("bucket_id" = 'content-files'::"text"));
